        ...
        <div className="row g-0">
          ...
          <div className="col-md-8">
            <div className="card-body">
              <h5 className="card-title" style={{ fontSize: 'clamp(1.25rem, 2vw, 2.5rem)' }}> Understanding the Importance of Peer Assessment </h5>
      ...
      <div className="card mb-3" style={{ maxWidth: '80em' }}>
        <div className="row g-10">
          <div className="col-md-8 order-md-1">
            <div className="card-body">
              <h5 className="card-title" style={{ fontSize: 'clamp(1.25rem, 2vw, 2.5rem)' }}>How it works</h5>
              <p className="card-text" style={{ fontSize: 'clamp(1rem, 1.5vw, 2rem)', textAlign: 'justify'}}>
